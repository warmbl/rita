...
const rita_hair_massive = [
    ...
    {name: '9',path: hair[8]},
    {name: '10',path: hair[9]},
    {name: '11',path: hair[10]},
    {name: '12',path: hair[11]},
    {name: '13',path: hair[12]},
    {name: '14',path: hair[13]},
    {name: '15',path: hair[14]},
    {name: '16',path: hair[15]},
    {name: '17',path: hair[16]},
    {name: '18',path: hair[17]},
    {name: '19',path: hair[18]},
    {name: '20',path: hair[19]},
    {name: '21',path: hair[20]},
    {name: '22',path: hair[21]},
    {name: '23',path: hair[22]},
    {name: '24',path: hair[23]},
    {name: '25',path: hair[24]},
    {name: '26',path: hair[25]},
    {name: '27',path: hair[26]},
    {name: '28',path: hair[27]},
];
const rita_clother_massive = [
    {name: '1',path: clother[0]},
    {name: '2',path: clother[1]},
    {name: '3',path: clother[2]},
    {name: '4',path: clother[3]},
    {name: '5',path: clother[4]},
